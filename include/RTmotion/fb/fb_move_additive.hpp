 ...
 * \image html MC_MoveAdditive.png width=1000cm
 * \image html MoveAdditive_Example.png width=1000cm
 */
class FbMoveAdditive : public FbAxisMotion
{
public:
  FbMoveAdditive();
  ~FbMoveAdditive() = default;

  void setDistance(LREAL distance)
  {
    distance_ = distance;
  }
...
private:
  VAR_INPUT LREAL& distance_ = position_;
};
}  // namespace RTmotion
